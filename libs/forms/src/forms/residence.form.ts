...
@Injectable()
export class ResidenceFormModel {
  // Readonly fields
...
export class ResidenceFormConfig
  implements IFormelloConfig<ResidenceFormModel>
{
  model: ResidenceFormModel;
  rows: Array<IFormelloRow>;

  constructor(model: ResidenceFormModel) {
    this.model = model;
    this.rows = [
      {
        fields: [
